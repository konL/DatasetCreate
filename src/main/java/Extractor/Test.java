...
public class Test {
    ...
    private static void ProjectCommit(String project) throws Exception {
        ...
        String finalCom=readCurCommit("C:\\Users\\delll\\IdeaProjects\\DatasetCreate\\src\\main\\resources\\log.txt");
...
//                    System.out.println(curCom+","+oldCom);
    ...
    private static void genFile(String project, String loc, String curCom, String change) throws Exception {
        ...
        //newCom读取当前的代码
        generateNew(srcAnddst[0],curCom,fileName_n,"C:\\project\\IdentifierStyle\\data\\VersionDB\\ver_new\\"+project+"\\"+curCom+"_"+change+"_"+fileName_n);

        //oldcam读取记录代码的上一个版本
        generateOld(srcAnddst[1],fileName_o,"C:\\project\\IdentifierStyle\\data\\VersionDB\\ver_old\\"+project+"\\"+curCom+"_"+change+"_"+fileName_o);
